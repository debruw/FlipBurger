    ...
    public class ObiSoftbodySurfaceBlueprint : ObiSoftbodyBlueprintBase
    {
        ...
        protected override IEnumerator Initialize()
        {
            ...
            for (int i = 0; i < particles.Count; ++i)
            {
                ...
                ObiUtils.GetPointCloudAnisotropy(neighbourVertices, maxAnisotropy, particleRadius, ref avgNormal, ref centroid, ref orientation, ref principalValues);
                ...
                phases[i] = ObiUtils.MakePhase(1, oneSided ? Oni.ParticleFlags.OneSided : 0); 
